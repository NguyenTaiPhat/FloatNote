...
import { Archive, Grid, List, Clock } from 'lucide-react';
...
export default function ArchivedPage() {
    ...
    useEffect(() => {
        loadCards({ workspaceId: activeWorkspaceId || undefined, archived: true });
    }, [activeWorkspaceId]);
                    ...
                    <div className="h-full flex items-center justify-center">
                        <div className="text-center">
                            <div className="w-20 h-20 rounded-full bg-surface mx-auto mb-4 flex items-center justify-center">
                                <Archive size={32} className="text-text-tertiary" />
                            </div>
                            <h2 className="text-xl font-semibold text-text-primary mb-2">No archived cards</h2>
                            <p className="text-text-secondary">
                                Archive cards to keep them out of your main view
                            </p>
                        </div>
                    </div>
                ) : viewMode === 'timeline' ? (
